...
ALTER TABLE
  "intention"
ADD
  CONSTRAINT "intention_chronicle_id_foreign" FOREIGN KEY("chronicle_id") REFERENCES "chronicle"("id");
ALTER TABLE
  "achievement"
ADD
...
ALTER TABLE
  "achievement"
ADD
  CONSTRAINT "achievement_chronicle_id_foreign" FOREIGN KEY("chronicle_id") REFERENCES "chronicle"("id");
ALTER TABLE
  "objective_action"
ADD
  CONSTRAINT "objective_action_chronicle_id_foreign" FOREIGN KEY("chronicle_id") REFERENCES "chronicle"("id");
ALTER TABLE
  "completed_action"
ADD
...
ALTER TABLE
  "completed_action"
ADD
  CONSTRAINT "completed_action_chronicle_id_foreign" FOREIGN KEY("chronicle_id") REFERENCES "chronicle"("id");
ALTER TABLE
  "completed_intention"
ADD
  CONSTRAINT "completed_intention_chronicle_id_foreign" FOREIGN KEY("chronicle_id") REFERENCES "chronicle"("id");